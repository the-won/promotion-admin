<template>
  <div class="hotdeal-row3-editor">
      ...
      >
        ...
        <div class="form-row mb-3">
          <div class="form-group">
            <label>상품코드 1</label>
            <input type="text" v-model="productSet.products[0].productId" placeholder="상품코드" class="form-input" />
          </div>
          <div class="form-group">
            <label>대체 텍스트 1</label>
            <input type="text" v-model="productSet.products[0].imageAlt" placeholder="대체 텍스트" class="form-input" />
          </div>
          <div class="form-group">
            <label>이미지 URL 1</label>
            <input type="url" v-model="productSet.products[0].imageUrl" placeholder="이미지 URL" class="form-input" />
          </div>
        </div>
        ...
        <div class="form-row mb-3">
          <div class="form-group">
            <label>상품코드 2</label>
            <input type="text" v-model="productSet.products[1].productId" placeholder="상품코드" class="form-input" />
          </div>
          <div class="form-group">
            <label>대체 텍스트 2</label>
            <input type="text" v-model="productSet.products[1].imageAlt" placeholder="대체 텍스트" class="form-input" />
          </div>
          <div class="form-group">
            <label>이미지 URL 2</label>
            <input type="url" v-model="productSet.products[1].imageUrl" placeholder="이미지 URL" class="form-input" />
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group">
            <label>상품코드 3</label>
            <input type="text" v-model="productSet.products[2].productId" placeholder="상품코드" class="form-input" />
          </div>
          <div class="form-group">
            <label>대체 텍스트 3</label>
            <input type="text" v-model="productSet.products[2].imageAlt" placeholder="대체 텍스트" class="form-input" />
          </div>
          <div class="form-group">
            <label>이미지 URL 3</label>
            <input type="url" v-model="productSet.products[2].imageUrl" placeholder="이미지 URL" class="form-input" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="text-center mt-4">
      <button @click="addRow" class="btn btn-primary btn-lg">새 3단 상품 추가</button>
    </div>
  </div>
</template>
