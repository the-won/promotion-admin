    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;">
          ...
          <tr><td><img :src="data.heroImage" style="width:100%;" /></td></tr>
          <tr>
          ...
          <tr>
            <td align="center" style="padding:20px;">
              <a :href="data.buttonLink" :style="'padding:12px 30px;color:#fff;border-radius:6px;background:'+data.buttonColor+';text-decoration:none;'">{{ data.buttonText }}</a>
            </td>
          </tr>
          <tr>
